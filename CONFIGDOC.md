...
For example, register a Jenkins tool named `Latest` by automatically installing the latest release of MATLAB, MATLAB Test&trade;, and Parallel Computing Toolbox&trade;.
